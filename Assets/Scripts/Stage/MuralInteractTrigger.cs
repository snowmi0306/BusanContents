...
public class MuralInteractTrigger : MonoBehaviour
{
    ...
    [SerializeField] private bool useCustomHintPositions = true;
    [SerializeField] private Transform interactHintAnchor;
    [SerializeField] private Transform notEnoughHintAnchor;
    ...
    private void Awake()
    {
        ApplyHintPosition(interactHint, interactHintAnchor);
        ApplyHintPosition(notEnoughLetterHint, notEnoughHintAnchor);
    ...
    private void ApplyHintPosition(GameObject hintObject, Transform anchor)
    {
        if (!useCustomHintPositions || hintObject == null || anchor == null)
        {
            return;
        }

        hintObject.transform.position = anchor.position;
    }
}
